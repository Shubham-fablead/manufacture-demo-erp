...
@section('content')
    <style>
        ...
        @media screen and (max-width: 575.98px) {
            ...
            /* Show only Sr No, Product Name and Details */
        ...
        <div class="page-header">
            <div class="page-title">
                ...
                <div class="inventory-tabs">
                    <a href="{{ route('inventory.list') }}" class="inventory-tab active">Stock Inventory</a>
                    <a href="{{ route('row_material.inventory') }}" class="inventory-tab">Material Inventory</a>
                </div>
            </div>
            <div class="page-btn">
...
@push('js')
                    ...
                    success: function(response) {
                        ...
                        if (response.inventory && response.inventory.length > 0) {
                            ...
                            <div class="inventory-table-actions">
                                <a class="btn btn-primary" href="/inventory-View/${p.id}" style="color: white;font-size: 13px;">
                                    View History
                                </a>
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            $.each(products, function(index, product) {
                                ...
                                let actionBtns = `
        <div class="inventory-table-actions">
            <a class="btn btn-primary" href="/inventory-View/${id}" style="color: white;font-size: 13px;">View History</a>
    ...
    <script>
        $(document).ready(function() {
            ...
            let currentPage = 1;
            let lastPage = 1;
            let perPage = $('#per-page-select-bottom').val() || 10;
            let searchQuery = '';
