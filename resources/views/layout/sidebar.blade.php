...
<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            ...
            {{-- Search Bar (ported from ERP-ACshop) --}}
            ...
            <ul class="sidebar-nav-list">
                ...
                @if (app('hasPermission')(0, 'view'))
                    <li class="sidebar-dashboard-item">
                        <a href="{{ route('auth.dashboard') }}"
                           class="{{ request()->routeIs('auth.dashboard') ? 'active' : '' }}">
                            <img src="{{ env('ImagePath') . '/admin/assets/img/icons/dashboard.svg' }}" alt="img">
                            <span>Dashboard</span>
                        </a>
                    </li>
                @endif
                ...
                @php
                    $showErpSection =
                        ...
                        app('hasPermission')(17, 'view') || app('hasPermission')(28, 'view') || app('hasPermission')(29, 'view') ||
                        app('hasPermission')(4, 'view') || app('hasPermission')(4, 'add') ||
                ...
                @if ($showErpSection)
                        ...
                        <ul>
                            @if (app('hasPermission')(1, 'view') || app('hasPermission')(1, 'add'))
                                <li class="submenu sidebar-module">
                                    <a href="javascript:void(0);">
                                        <img src="{{ env('ImagePath') . '/admin/assets/img/icons/product.svg' }}" alt="img">
                            ...
                            @if (app('hasPermission')(2, 'view') || app('hasPermission')(2, 'add'))
                                <li class="submenu sidebar-module">
                                    <a href="javascript:void(0);">
                                        <img src="{{ env('ImagePath') . '/admin/assets/img/icons/sales1.svg' }}" alt="img">
                    ...
                    @endif
                            ...
                            @if (app('hasPermission')(4, 'view') || app('hasPermission')(4, 'add'))
                                <li class="submenu sidebar-module">
                                    <a href="javascript:void(0);">
                                        ...
                                        <span>Invoices</span> <span class="menu-arrow"></span>
                                    </a>
                                    <ul>
                            ...
                            @endif
                            @if ((app('hasPermission')(2, 'add') && app('hasPermission')(2, 'edit')) || (app('hasPermission')(3, 'add') && app('hasPermission')(3, 'edit')))
                                <li class="submenu sidebar-module">
                                    <a href="javascript:void(0);">
                ...
                @php
                    $showAccountingSection =
                        app('hasPermission')(16, 'view') || app('hasPermission')(16, 'add') ||
                        app('hasPermission')(5, 'view') || app('hasPermission')(5, 'add') ||
                        app('hasPermission')(28, 'view') ||
                        app('hasPermission')(20, 'view') ||
                        app('hasPermission')(2, 'view') || app('hasPermission')(3, 'view') || app('hasPermission')(5, 'view');
                @endphp
                    ...
                    <li class="submenu sidebar-category sidebar-category-accounting">
                        ...
                        <ul>
                            ...
                            @if (app('hasPermission')(5, 'view') || app('hasPermission')(5, 'add'))
                                <li class="submenu sidebar-module">
                                    <a href="javascript:void(0);">
                                        <img src="{{ env('ImagePath') . '/admin/assets/img/icons/expense1.svg' }}" alt="img">
                            ...
                            @if (app('hasPermission')(28, 'view'))
                                ...
                                <li class="submenu sidebar-module">
                                    ...
                                    <ul>
                                        @if (app('hasPermission')(28, 'view'))
                                            <li><a href="{{ route('credit-notes-items.index') }}">Credit Notes</a></li>
                                            <li><a href="{{ route('debit-notes-items.index') }}">Debit Notes</a></li>
                                            <li><a href="{{ route('credit-notes.index') }}">Credit/Debit Notes Type</a></li>
                                        @endif
                                    </ul>
                                </li>
                            @endif
                ...
                @if (app('hasPermission')(14, 'view') || app('hasPermission')(15, 'view'))
                    <li class="submenu sidebar-category sidebar-category-settings">
                        ...
                        <ul>
                                ...
                                <li><a href="{{ route('plans.planlist') }}" class="{{ request()->routeIs('plans.planlist') ? 'active' : '' }}">Plans</a></li>
                                <!-- <li><a href="{{ route('plans.details') }}" class="{{ request()->routeIs('plans.details') ? 'active' : '' }}">Plan Details</a></li> -->
                            @endif
                            @if (in_array(auth()->user()->role, ['admin', 'sub-admin']))
                                <li><a href="{{ route('plans.myplan') }}">My Plan Details</a></li>
                            @endif
                            @if (app('hasPermission')(14, 'view'))
                            ...
                            @if (app('hasPermission')(14, 'view') && $showWhatsappConfiguration)
                                <li><a href="{{ route('setting.facebookappconfiguration') }}">WhatsApp Configuration</a></li>
                            @endif
