    ...
    <script>
        $(document).ready(function() {
            ...
            function renderMobileReturnCards(data) {
                ...
                data.forEach((item, index) => {
                    ...
                    const orderLink = item.order_number ?
                        `<a href="/sales-details/${item.order_id}" style="color:#ff9f43;font-weight:600;">${escapeHtml(item.order_number)}</a>` :
                        '-';
                        ...
                        <div class="mobile-order-item" data-return-id="${item.id}">
                            ...
                            <div class="mobile-order-details" id="mobile-return-details-${item.id}">
                                ...
                                <div class="mobile-detail-row">
                                    ...
                                    <span class="mobile-detail-value">${orderLink}</span>
                                </div>
                                <div class="mobile-detail-row">
            ...
            function updatePaginationUI(pagination) {
                ...
                paginationHtml += `
                    <li class="page-item ${pagination.current_page === 1 ? 'disabled' : ''}">
                        <a class="page-link sales-return-page-link" href="javascript:void(0);" data-page="${pagination.current_page - 1}">Previous</a>
                    </li>
                `;
                ...
                if (startPage > 1) {
                    paginationHtml += `
                        <li class="page-item">
                            <a class="page-link sales-return-page-link" href="javascript:void(0);" data-page="${startPage - 1}" data-action="prev-group">..</a>
                        </li>
                    `;
                }
                ...
                for (let i = startPage; i <= endPage; i++) {
                    paginationHtml += `
                        <li class="page-item ${i === pagination.current_page ? 'active' : ''}">
                            <a class="page-link sales-return-page-link" href="javascript:void(0);" data-page="${i}">${i}</a>
                        </li>
                    `;
                }
                ...
                if (endPage < pagination.last_page) {
                    paginationHtml += `
                        <li class="page-item">
                            <a class="page-link sales-return-page-link" href="javascript:void(0);" data-page="${endPage + 1}" data-action="next-group">..</a>
                        </li>
                    `;
                }
                ...
                paginationHtml += `
                    <li class="page-item ${pagination.current_page === pagination.last_page || pagination.last_page === 0 ? 'disabled' : ''}">
                        <a class="page-link sales-return-page-link" href="javascript:void(0);" data-page="${pagination.current_page + 1}">Next</a>
                    </li>
                `;
            ...
            $(document).off('click', '#pagination-numbers .page-link')
                .off('click', '.sales-return-page-link')
                .on('click', '.sales-return-page-link', function(e) {
                    e.preventDefault();
                    ...
                    if (action === 'prev-group') {
                        ...
                        if (prevStartPage >= 1) {
                            fetchSalesReturns(prevStartPage);
                        }
                        return;
                    }
